...
[^1]: AI was used for assistance in this project. It was used for code clarification, exception explanations, and discussions on how ggplot2, dplyr, and other packages operate. I used code snippets only when I was absolutely stuck on a problem–I'm trying to learn data visualization. All text is authored exclusively by me.
...
\
I removed the "° Celsius" from the y-label as the temperatures are labeled. I also wanted to indicate the temps are for the return trip. Minard does this every eloquently using lines from the temperature plot to the returning troo map. I am not like Minard but thought the information was important.\
\

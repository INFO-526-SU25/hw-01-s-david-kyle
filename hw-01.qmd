...
[^1]: AI was used for assistance in this project. It was used for code clarification, exception explanations, and discussions on how ggplot2, dplyr, and other packages operate. I used code snippets only when I was unable to resolve an issue independently. All text is authored exclusive
